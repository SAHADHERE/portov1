...
export default function ContactForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoUrl = `mailto:${portfolioConfig.personalInfo.email}?subject=Message from ${encodeURIComponent(name)}&body=Sender Email: ${encodeURIComponent(email)}%0D%0A%0D%0AMessage:%0D%0A${encodeURIComponent(message)}`
  ...
  const socialLinks = [
    {
      ...
      user: '@github',
      icon: FaGithub,
      link: portfolioConfig.personalInfo.githubUrl,
    },
    {
      title: 'Discord',
      user: `@${portfolioConfig.personalInfo.discordUser || 'discord'}`,
      icon: FaDiscord,
      link: 'https://discord.com',
    },
    {
      title: 'Telegram',
      user: `@${portfolioConfig.personalInfo.telegramUser || 'telegram'}`,
      icon: FaTelegramPlane,
      link: `https://t.me/${portfolioConfig.personalInfo.telegramUser}`,
    },
    {
      title: 'Email',
      user: portfolioConfig.personalInfo.email,
      icon: Mail,
      link: `mailto:${portfolioConfig.personalInfo.email}`,
    },
  ]
  return (
    <motion.div
    ...
    >
      ...
      <div className="border-t border-white/10 pt-5 mt-6">
        ...
        {/* LINKEDIN */} 
        {portfolioConfig.personalInfo.linkedinUrl && (
          <motion.a
            href={portfolioConfig.personalInfo.linkedinUrl}  
            target="_blank"
