...
const skills = portfolioConfig.personalInfo.skills;
...
export default function Hero({ showApp }: HeroProps) {
  ...
  const roleParts = portfolioConfig.personalInfo.role.split(" ");
  const firstRolePart = roleParts[0] || "Frontend";
  const secondRolePart = roleParts.slice(1).join(" ") || "Developer";
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ✦ {portfolioConfig.personalInfo.availability}
          </span>
        </motion.div>
        ...
        >
          ...
          >
            <TextType
              text={portfolioConfig.personalInfo.typedStatuses}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              cursorCharacter="_"
